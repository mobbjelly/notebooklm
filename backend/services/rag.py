...
async def rag_stream(
    ...
    # 1. 检索相关文档块
    chunks, citations = await asyncio.to_thread(_retrieve, question, notebook_id, doc_ids)
...
def _retrieve(question: str, notebook_id: int, doc_ids: list[int] | None) -> tuple[list[str], list[dict]]:
